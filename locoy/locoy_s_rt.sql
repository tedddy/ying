...
-- INSERT INTO `hs_s_rt_EM` (`code`, `close`, `amount`, `volume`, `chgrate`, `WeiBi`, `chgrate5`, `LiangBi`, `TimeSlot`) VALUES (ids, close, amount, volume, chgrate, WeiBi, chgrate5, LiangBi, dt) 
