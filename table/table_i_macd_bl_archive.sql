SELECT * FROM ying_calc.temp_i_macd_bl_archive order by dt desc;

SELECT * FROM ying_calc.i_macd_bl_archive order by dt desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `idi` = '399006' order by dt desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `idi` = '399959' order by dt desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `idi` = '399393' order by dt desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `idi` = '399934' order by dt desc;


SELECT * FROM ying_calc.i_macd_bl_archive where `idi` = '000974' order by dt desc;


SELECT * FROM ying_calc.i_macd_bl_archive where `dt` = '2016-03-04' order by close_d1 desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `dt` = '2016-03-04' order by macdOsc_cl_d1 desc;

SELECT * FROM ying_calc.i_macd_bl_archive join ying_calc.i_info on i_macd_bl_archive.idi = i_info.idi where i_macd_bl_archive.`dt` = '2016-03-04' and i_macd_bl_archive.macdOsc_cl > -10 and i_macd_bl_archive.macdOsc_cl < 10 order by i_macd_bl_archive.macdOsc_cl desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `dt` = '2016-03-03' order by macdOsc_cl_d1 desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `dt` = '2016-03-02' order by macdOsc_cl_d1 desc;

SELECT * FROM ying_calc.i_macd_bl_archive where `dt` = '2016-03-01' order by macdOsc_cl_d1 desc;


-- DROP TABLE `ying_calc`.`i_macd_bl_archive`;
CREATE TABLE `ying_calc`.`i_macd_bl_archive` (
  `idi` CHAR(6),
  `dt` DATE,
...
CALL `ying_calc`.`i_macd_bl_archive_import`;

DROP PROCEDURE `ying_calc`.`i_macd_bl_archive_import`;
DELIMITER $$
CREATE DEFINER=`gxh`@`%` PROCEDURE `ying_calc`.`i_macd_bl_archive_import`()
BEGIN
INSERT INTO `ying_calc`.`i_macd_bl_archive`
(`idi`,
`dt`,
`close`,
`macd_cl`,
