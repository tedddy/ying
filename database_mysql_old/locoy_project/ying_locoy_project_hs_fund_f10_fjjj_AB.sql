ying locoy project hs_fund_f10_fjjj_AB

Steps:
1. change hs_fund_f10_fjjj_AB
...
CREATE TABLE `hs_fund_f10_fjjj_AB` (
...
INSERT INTO `hs_fund_f10_fjjj_AB` (`code`, `jjjz_forecast`, `chgrate_jjjz_forecast`, `jjjz`, `date_jjjz`, `chgrate_jjjz`, `mother`, `mktcap`, `date_mktcap`, `ltsz`, `date_ltsz`, `index_target`, `name_full`, `name`, `cat`, `date_start`, `mktcap_start`, `fund_managing_company`, `fund_company_url`, `fund_manager`, `convert_fixed`, `convert_conditional`, `return_fixed`, `TimeSys`, `DateSys`) VALUES (code, jjjz_forecast, chgrate_jjjz_forecast, jjjz, date_jjjz, chgrate_jjjz, mother, mktcap, date_mktcap, ltsz, date_ltsz, index_target, name_full, name, cat, date_start, mktcap_start, fund_managing_company, fund_company_url, fund_manager, convert_fixed, convert_conditional, return_fixed, TimeSys, DateSys) 
...
CALL hs_fund_f10_fjjj_AB('[标签:code]','[标签:jjjz_forecast]','[标签:chgrate_jjjz_forecast]','[标签:jjjz]','[标签:date_jjjz]','[标签:chgrate_jjjz]','[标签:mother]','[标签:mktcap]','[标签:date_mktcap]','[标签:ltsz]','[标签:date_ltsz]','[标签:index_target]', '[标签:name_full]','[标签:name]','[标签:cat]','[标签:date_start]','[标签:mktcap_start]','[标签:fund_managing_company]','[标签:fund_company_url]','[标签:fund_manager]','[标签:convert_fixed]','[标签:convert_conditional]','[标签:return_fixed]', '','');

CALL hs_fund_f10_fjjj_AB_current('[标签:code]','[标签:jjjz_forecast]','[标签:chgrate_jjjz_forecast]','[标签:jjjz]','[标签:date_jjjz]','[标签:chgrate_jjjz]','[标签:mother]','[标签:mktcap]','[标签:date_mktcap]','[标签:ltsz]','[标签:date_ltsz]','[标签:index_target]', '[标签:name_full]','[标签:name]','[标签:cat]','[标签:date_start]','[标签:mktcap_start]','[标签:fund_managing_company]','[标签:fund_company_url]','[标签:fund_manager]','[标签:convert_fixed]','[标签:convert_conditional]','[标签:return_fixed]', '','')

CREATE TABLE `hs_fund_f10_fjjj_AB_current` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `code` VARCHAR(6) DEFAULT NULL COMMENT 'code',
  `jjjz_forecast` decimal(7,4) unsigned DEFAULT NULL COMMENT 'jjjz_forecast',
  `chgrate_jjjz_forecast` decimal(5,2) DEFAULT NULL COMMENT 'chgrate_jjjz_forecast',
...
DELIMITER $$
CREATE DEFINER=`gxh`@`%` PROCEDURE `hs_fund_f10_fjjj_AB_current`(IN code VARCHAR(18), jjjz_forecast VARCHAR(18), chgrate_jjjz_forecast VARCHAR(18), jjjz VARCHAR(18), date_jjjz VARCHAR(18), chgrate_jjjz VARCHAR(18), mother VARCHAR(18), mktcap VARCHAR(18), date_mktcap VARCHAR(18), ltsz VARCHAR(18), date_ltsz VARCHAR(18), index_target VARCHAR(28),name_full VARCHAR(18), name VARCHAR(28), cat VARCHAR(18), date_start VARCHAR(18), mktcap_start VARCHAR(18), fund_managing_company VARCHAR(18), fund_company_url VARCHAR(58), fund_manager VARCHAR(38), convert_fixed VARCHAR(58), convert_conditional VARCHAR(98), return_fixed VARCHAR(18), TimeSys TIME, DateSys DATE)
BEGIN
SET code = IF(code = '', NULL, code);
SET jjjz_forecast = IF(jjjz_forecast = '', NULL, jjjz_forecast);
SET chgrate_jjjz_forecast = IF(chgrate_jjjz_forecast = '', NULL, chgrate_jjjz_forecast);
...
INSERT INTO `hs_fund_f10_fjjj_AB_current` (`code`, `jjjz_forecast`, `chgrate_jjjz_forecast`, `jjjz`, `date_jjjz`, `chgrate_jjjz`, `mother`, `mktcap`, `date_mktcap`, `ltsz`, `date_ltsz`, `index_target`, `name_full`, `name`, `cat`, `date_start`, `mktcap_start`, `fund_managing_company`, `fund_company_url`, `fund_manager`, `convert_fixed`, `convert_conditional`, `return_fixed`, `TimeSys`, `DateSys`) VALUES (code, jjjz_forecast, chgrate_jjjz_forecast, jjjz, date_jjjz, chgrate_jjjz, mother, mktcap, date_mktcap, ltsz, date_ltsz, index_target, name_full, name, cat, date_start, mktcap_start, fund_managing_company, fund_company_url, fund_manager, convert_fixed, convert_conditional, return_fixed, TimeSys, DateSys) 
ON DUPLICATE KEY UPDate 
`code` = IF(code IS NULL, `code`, code),
`jjjz_forecast` = IF(jjjz_forecast IS NULL, `jjjz_forecast`, jjjz_forecast),
`chgrate_jjjz_forecast` = IF(chgrate_jjjz_forecast IS NULL, `chgrate_jjjz_forecast`, chgrate_jjjz_forecast),
