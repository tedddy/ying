...
BEGIN
SET @close10_lag:=0.00;
UPDATE `ying_calc`.`s_xts_adj_sma` t
        INNER JOIN
    (SELECT 
        `d`,
	`ids`,
	ROUND(100 * (close10 - @close10_lag) / close10, 2) AS `close10_d1`,
	@close10_lag:=close10
    FROM
...
-- 1275989 row(s) affected, 12 warning(s): 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1 1264 Out of range value for column 'close10_d1' at row 1
