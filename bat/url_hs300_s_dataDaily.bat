...
move "Y:\stock\url_hs300_s_dataDaily_*.txt" "Y:\url_ying\_archive"
del "Y:\stock\url_hs300_s_dataDaily.txt"

REM PAUSE

"C:\Program Files\MySQL\MySQL Server 5.6\bin\mysql"  -u gxh -plocoy -h 192.168.137.172 ying -e "SELECT concat('http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/MoneyFlow.ssl_qsfx_lscjfb?daima=',hs300_s_data.code, '&page=1&num=1&sort=opendate&asc=0') FROM  ying.hs300_s_data;" > "Y:\stock\url_hs300_s_dataDaily_%today%.txt"

REM PAUSE

MORE /E +1 "Y:\stock\url_hs300_s_dataDaily_%today%.txt" > "Y:\stock\url_hs300_s_dataDaily.txt"
