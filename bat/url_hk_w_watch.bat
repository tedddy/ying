...
move "Y:\url_ying\url_hk_w_watch_*.txt" "Y:\url_ying\_archive"
del "Y:\url_ying\url_hk_w_watch.txt"
...
MORE /E +1 "Y:\url_ying\url_hk_w_watch_%today%.txt" > "Y:\url_ying\url_hk_w_watch.txt"
