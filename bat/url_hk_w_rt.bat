...
move "Y:\url_ying\url_hk_w_rt_*.txt" "Y:\url_ying\_archive"
del "Y:\url_ying\url_hk_w_rt.txt"
...
MORE /E +1 "Y:\url_ying\url_hk_w_rt_%today%.txt" > "Y:\url_ying\url_hk_w_rt.txt"
