...
move "Y:\url_ying\index_xts_hst_sina_2015_*.txt" "Y:\url_ying\_archive"
del "Y:\url_ying\index_xts_hst_sina_2015.txt"
...
MORE /E +1 "Y:\url_ying\index_xts_hst_sina_2015_%today%.txt" > "Y:\url_ying\index_xts_hst_sina_2015.txt"
