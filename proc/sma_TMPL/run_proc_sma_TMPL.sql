...
CALL `ying_calc`.`s_xts_adj_ids_d_close_sma_multiPeriods_loop_dt_ids` (date_sub(curdate(), interval 1 DAY), '2018-08-08', 5, 10, 20, 30, 60, 120); 

CALL `ying_calc`.`s_xts_adj_ids_d_amount_sma_multiPeriods_loop_dt_ids` (date_sub(curdate(), interval 1 DAY), '2018-08-08', 5, 10, 20, 30, 60, 120); 
