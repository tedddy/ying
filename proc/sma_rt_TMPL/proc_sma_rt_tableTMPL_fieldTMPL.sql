-- Test the proc
	...
	CALL `sma_rt_tableTMPL_fieldTMPL`('601318', 1.20, 20, @out_sma_3);
	CALL `sma_rt_tableTMPL_fieldTMPL`('601318', 1.20, 30, @out_sma_4);
	CALL `sma_rt_tableTMPL_fieldTMPL`('601318', 1.20, 60, @out_sma_5);
	CALL `sma_rt_tableTMPL_fieldTMPL`('601318', 1.20, 120, @out_sma_6);
