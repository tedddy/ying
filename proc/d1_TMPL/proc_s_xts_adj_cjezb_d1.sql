...
ALTER TABLE `ying_calc`.`s_xts_adj` ADD COLUMN `cjezb_d1` DECIMAL(5,2) NULL COMMENT '' AFTER `cjezb`;

-- UPDATE value of d1 into s_xts_adj

DROP PROCEDURE IF EXISTS `ying_calc`.`s_xts_adj_cjezb_d1`;

DELIMITER $$
CREATE DEFINER=`gxh`@`%` PROCEDURE `ying_calc`.`s_xts_adj_cjezb_d1`()
BEGIN
...
-- Reference: file E:\bYun\securities\ying\learning\learning.sql; search key words: learning and researching E:\bYun\securities\ying\proc\d1_TMPL\proc_s_xts_adj_cjezb_d1.sql 
