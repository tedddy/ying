...
ALTER TABLE `ying_calc`.`index_rt_hst` ADD COLUMN `cjezb_d1` DECIMAL(6,2) NULL COMMENT '' AFTER `cjezb`;

-- UPDATE value of d1 into index_rt_hst

DROP PROCEDURE IF EXISTS `ying_calc`.`index_rt_hst_cjezb_d1`;

DELIMITER $$
CREATE DEFINER=`gxh`@`%` PROCEDURE `ying_calc`.`index_rt_hst_cjezb_d1`()
BEGIN
...
-- Reference: file E:\bYun\securities\ying\learning\learning.sql; search key words: learning and researching E:\bYun\securities\ying\proc\d1_TMPL\proc_index_rt_hst_cjezb_d1.sql 
